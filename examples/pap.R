...
devtools::load_all('/home/brent/git/hooke')
...
pap_cds <- readRDS("/home/brent/work/hooke_data/macrophage/PAP/pap.al_2021-09-15.cds.RDS")
...
#
# Broken: full_edges <- hooke:::collect_pln_graph_edges(ccm, cond_ra_vs_wt_tbl, model_for_pcors = "full") %>% dplyr::select(from, to, pcor)
#
