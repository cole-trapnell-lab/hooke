...
my_assemble_timeseries_transitions <- function(ccm,
                                               q_val=0.01,
                                               start_time = NULL,
                                               stop_time = NULL,
                                               interval_col="timepoint",
...
state_transition_graph = my_assemble_timeseries_transitions(meso_wt_ccm_wl,
...
plot_state_transition_graph(meso_wt_ccm_wl, state_transition_graph %>% igraph::as_data_frame(),
